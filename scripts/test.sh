...
if grep -q 'data-hear-after-need-five' src/app/page.tsx; then
...
hear_after_need_four_rule="$(awk '/\.opening-listen\.hear-after-need\.hear-after-need-two\.hear-after-need-three\.hear-after-need-four \{/,/\}/' src/app/board.css)"
...
hear_after_need_four_keep="$(awk '/\.opening-listen\.hear-after-need\.hear-after-need-two\.hear-after-need-three\.hear-after-need-four \{/,/\}/' src/app/board.css)"
