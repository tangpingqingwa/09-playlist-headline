...
The occupied board names the rolling last-7-days window. Occupied Hear and later tracks name last 7 days, not this calendar week. Empty station copy names the same fair window without occupied rolling chrome. Empty Claim #1 and the empty deck kicker name last 7 days, not this calendar week. Empty lede names last 7 days, not this calendar week. Empty stays Claim #1 first, no Hear. Monday 00:00 UTC remains the ISO `weekId` label, not the public expiry. Not a 24h lock on #1.
